...
**App version: v0.08 · Everything ships in `Shopping-App-v0.08.zip`**
...
- The file `Shopping-App-v0.08.zip` (download it from the workspace)

---

## Step 1 — Download & unzip the app

1. Download `Shopping-App-v0.08.zip` and unzip it.
...
git init
git add .
git commit -m "Shopping App v0.08"
git branch -M main
...
2. Quick test loop:
   ...
   - **More tab** → confirm **v0.08** is shown at the bottom.
