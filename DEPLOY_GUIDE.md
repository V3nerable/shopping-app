...
**App version: v0.06 · Everything ships in `Shopping-App-v0.06.zip`**
...
- The file `Shopping-App-v0.06.zip` (download it from the workspace)

---

## Step 1 — Download & unzip the app

1. Download `Shopping-App-v0.06.zip` and unzip it.
...
git init
git add .
git commit -m "Shopping App v0.06"
git branch -M main
...
2. Quick test loop:
   ...
   - **More tab** → confirm **v0.06** is shown at the bottom.
