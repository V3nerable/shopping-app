...
**App version: v0.25 · Everything ships in `Shopping-App-v0.25.zip`**
...
- The file `Shopping-App-v0.25.zip` (download it from the workspace)

---

## Step 1 — Download & unzip the app

1. Download `Shopping-App-v0.25.zip` and unzip it.
...
git init
git add .
git commit -m "Shopping App v0.25"
git branch -M main
...
2. Quick test loop:
   ...
   - **More tab** → confirm **v0.25** is shown at the bottom.
